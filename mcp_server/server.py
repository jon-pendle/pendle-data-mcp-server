...
def _build_instructions() -> str:
    ...
    return (
        ...
        "3. Call get_table_detail(table_name) to load full column definitions, "
        "aggregation rules, and SQL examples for the table(s) you need.\n"
        "4. Write SQL and execute via run_sql(). Follow the catalog's "
        "aggregation rules.\n"
        "   Do NOT query INFORMATION_SCHEMA — it is not allowed. "
        "Use get_table_detail() for column info instead.\n"
